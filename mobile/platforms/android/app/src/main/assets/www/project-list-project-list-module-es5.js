...
var ProjectListPageRoutingModule = /** @class */ (function () {
    function ProjectListPageRoutingModule() {
    }
    ...
    return ProjectListPageRoutingModule;
}());
...
var ProjectListPage = /** @class */ (function () {
    function ProjectListPage(dataService, util, apiService, referenceservice, navCtrl, events, modalController) {
    ...
    ProjectListPage.prototype.editProject = function (project) {
    ...
    ProjectListPage.prototype.ngOnInit = function () {
        var _this = this;
        this.page = false;
        ...
        this.projectList.forEach(function (value, key) {
            value.time = _this.time;
            _this.time = _this.time + 0.2;
            _this.projectList[key].opentasks = value.tasks_open.length;
            _this.projectList[key].completedtasks = value.tasks_completed.length;
        });
        this.applyClassBySelection('bounceInRight');
    };
    ProjectListPage.prototype.getHeaderStyle = function () {
        return { background: this.primaryColor };
    };
    ProjectListPage.prototype.openProject = function (project) {
        this.cssClass = '';
        this.navCtrl.navigateForward('/view-projects', { state: { 'project': project } });
    };
    ;
    ProjectListPage.prototype.createProject = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ProjectListPage.prototype.getFontstyle = function () {
        return { color: this.secondryColor };
    };
    ProjectListPage.prototype.applyClassBySelection = function (effect) {
        this.cssClass = "animated " + effect;
    };
    ProjectListPage.prototype.deleteProject = function (project) {
        var _this = this;
        this.cssClass = '';
        this.referenceservice.deleteAlert("Confirm Delete", "Do you want to delete this project").then(function (res) {
            console.log(res);
            _this.onDeleteConfirm(project);
        });
    };
    ProjectListPage.prototype.onDeleteConfirm = function (project) {
        var _this = this;
        var element = document.getElementById(project);
        element.classList.add('animated', 'rollOut', 'slow');
        element.addEventListener('animationend', (function (e) {
            _this.projectList.splice(project, 1);
            _this.util.showAlert('Smart HR', 'Project Removed successfully');
        }));
    };
    ProjectListPage.prototype.getProgresstyle = function () {
        return {
            background: "linear-gradient(to right," + this.secondryColor + "," + this.primaryColor + ")",
            height: '10px'
        };
    };
    ProjectListPage.ctorParameters = function () { return [
...
//# sourceMappingURL=project-list-project-list-module-es5.js.map