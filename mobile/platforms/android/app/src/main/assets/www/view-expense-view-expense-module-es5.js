...
var ViewExpensePageRoutingModule = /** @class */ (function () {
    function ViewExpensePageRoutingModule() {
    }
    ...
    return ViewExpensePageRoutingModule;
}());
...
var ViewExpensePage = /** @class */ (function () {
    function ViewExpensePage(util, navContrl) {
        this.util = util;
        this.navContrl = navContrl;
    }
    ViewExpensePage.prototype.ngOnInit = function () {
        var _this = this;
        this.util.getParams('expense').then(function (res) {
            _this.paymentInfo = res;
        });
    };
    ViewExpensePage.prototype.popBack = function () {
...
//# sourceMappingURL=view-expense-view-expense-module-es5.js.map