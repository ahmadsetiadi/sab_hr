...
var WalkthroughPageRoutingModule = /** @class */ (function () {
    function WalkthroughPageRoutingModule() {
    }
...
var WalkthroughPage = /** @class */ (function () {
    function WalkthroughPage(navContrl) {
    ...
    WalkthroughPage.prototype.getLocation = function () {
    ...
    WalkthroughPage.prototype.getStarted = function () {
        // this.navContrl.navigateRoot("/login");
        this.getLocation();
    };
    WalkthroughPage.prototype.getClass = function (i) {
        return this.slides1[i] ? 'slide' + (i + 1) + '-activated' : '';
    };
    WalkthroughPage.prototype.slideChanged = function (e) {
        var _this = this;
        this.slides.getActiveIndex().then(function (index) {
            console.log(index);
            _this.slides1 = [false, false, false];
            _this.slides1[index] = true;
        });
    };
    WalkthroughPage.prototype.previousSlide = function () {
