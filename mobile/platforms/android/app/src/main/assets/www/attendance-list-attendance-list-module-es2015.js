...
let AttendanceListPageRoutingModule = class AttendanceListPageRoutingModule {
};
...
let AttendanceListPageModule = class AttendanceListPageModule {
};
...
let AttendanceListPage = class AttendanceListPage {
    constructor(util, navCtrl, events, popoverController) {
        this.util = util;
...
AttendanceListPage.ctorParameters = () => [
...
//# sourceMappingURL=attendance-list-attendance-list-module-es2015.js.map