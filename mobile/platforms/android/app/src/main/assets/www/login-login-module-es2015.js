...
let LoginPage = class LoginPage {
    constructor(navCtrl, menuCtrl, fb, statusBar, referenceservice, apiservice, storage) {
    ...
    login() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const model = { username: this.model.username, password: this.model.password };
            const url = "user/login";
            const response = yield this.apiservice.postData(url, model); //console.log(response);
