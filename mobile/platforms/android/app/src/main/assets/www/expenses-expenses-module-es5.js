...
var ExpensesPageRoutingModule = /** @class */ (function () {
    function ExpensesPageRoutingModule() {
    }
...
var ExpensesPage = /** @class */ (function () {
    function ExpensesPage(util, navContrl, modalController, alertController) {
        this.util = util;
    ...
    ExpensesPage.prototype.edit = function () {
    ...
    ExpensesPage.prototype.openExpense = function (Details) {
        this.navContrl.navigateForward("/view-expense", { state: { 'expense': Details } });
    };
    ExpensesPage.prototype.addExpenses = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ExpensesPage.prototype.delete = function (i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ExpensesPage.prototype.successAlert = function (i) {
        var _this = this;
        var element = document.getElementById(i);
        element.classList.add('animated', 'rollOut', 'slow');
        element.addEventListener('animationend', (function (e) {
            _this.expenses.splice(i, 1);
            _this.util.showAlert('Smart HR', 'Expense Removed successfully');
        }));
    };
