...
var HomePage = /** @class */ (function () {
    function HomePage(popoverController, events, navController, referenceservice, apiservice, statusBar) {
        var _this = this;
        ...
        this.one = 30;
        this.call = false;
        events.subscribe('homeOptions', function (btn) {
    ...
    HomePage.prototype.showModal = function (ev) {
    ...
    HomePage.prototype.getHeaderStyle = function () {
        return { background: this.primaryColor };
    };
    HomePage.prototype.onPopOverDismiss = function (btn) {
        if (btn === "settings") {
    ...
    HomePage.prototype.openInvoices = function () {
        this.navController.navigateForward("/invoices");
    };
    HomePage.prototype.openEstimates = function () {
    ...
    HomePage.prototype.openEmployee = function () {
        this.navController.navigateForward("/employee-list");
    };
    HomePage.prototype.openTask = function () {
        this.navController.navigateForward("/task");
    };
    HomePage.prototype.openPayroll = function () {
        this.navController.navigateForward("/employee-salary");
    };
    HomePage.prototype.openAttedance = function () {
    ...
    HomePage.prototype.getFontstyle = function () {
        return { color: this.secondryColor };
    };
    HomePage.prototype.getProgresstyle = function () {
        return {
