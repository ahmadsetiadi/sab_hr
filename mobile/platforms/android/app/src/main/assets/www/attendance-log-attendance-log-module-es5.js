...
var AttendanceLogPageRoutingModule = /** @class */ (function () {
    function AttendanceLogPageRoutingModule() {
    }
    ...
    return AttendanceLogPageRoutingModule;
}());
...
var AttendanceLogPageModule = /** @class */ (function () {
    function AttendanceLogPageModule() {
    }
    ...
    return AttendanceLogPageModule;
}());
...
var AttendanceLogPage = /** @class */ (function () {
    function AttendanceLogPage(util, events, popoverController) {
        this.util = util;
        this.events = events;
    ...
    AttendanceLogPage.prototype.ngOnInit = function () {
        var _this = this;
        this.events.subscribe('calendarModal', function (btn) {
            _this.onPopOverDismiss(btn);
        });
    };
    AttendanceLogPage.prototype.onViewTitleChanged = function (title) {
        this.viewTitle = title;
    };
    AttendanceLogPage.prototype.onCurrentDateChanged = function (event) {
        var today = new Date();
        today.setHours(0, 0, 0, 0);
        event.setHours(0, 0, 0, 0);
        this.isToday = today.getTime() === event.getTime();
    };
    AttendanceLogPage.prototype.showModal = function (ev) {
    ...
    AttendanceLogPage.prototype.onPopOverDismiss = function (date) {
        this.calendar.currentDate = new Date(date.data);
    };
    AttendanceLogPage.prototype.ngOnDestroy = function () {
        this.events.unsubscribe('calendarModal');
    };
    AttendanceLogPage.ctorParameters = function () { return [
...
//# sourceMappingURL=attendance-log-attendance-log-module-es5.js.map