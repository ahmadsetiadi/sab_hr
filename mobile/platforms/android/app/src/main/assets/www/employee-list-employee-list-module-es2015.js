...
let EmployeeListPage = class EmployeeListPage {
    constructor(referenceservice, apiService, dataService, navCtrl, popoverCtrl, events, modalController, api) {
    ...
    ionViewWillEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            console.log("onenter");
            const url = "employee";
            const response = yield this.api.getData(url, {});
    ...
    delete(i) {
        this.referenceservice.deleteAlert("Confirm Delete", "Do you want to delete this employee").then(res => {
            console.log(res);
...
//# sourceMappingURL=employee-list-employee-list-module-es2015.js.map