...
var ViewProjectsPageRoutingModule = /** @class */ (function () {
    function ViewProjectsPageRoutingModule() {
    }
    ...
    return ViewProjectsPageRoutingModule;
}());
...
var ViewProjectsPageModule = /** @class */ (function () {
    function ViewProjectsPageModule() {
    }
...
var ViewProjectsPage = /** @class */ (function () {
    function ViewProjectsPage(router, navCtrl, modalController, referenceservice, activeRoute) {
        var _this = this;
        this.router = router;
        ...
        this.referenceservice.getParams('project').then(function (res) {
            _this.pro = res;
            console.log(_this.pro);
            _this.dateRange.from = new Date(_this.pro.start_date);
            _this.dateRange.to = new Date(_this.pro.overviews.deadline);
            _this.option.defaultDateRange = _this.dateRange;
            _this.option.defaultScrollTo = new Date(_this.pro.start_date);
            _this.opentasks = _this.pro.tasks_open.length;
            _this.completedtasks = _this.pro.tasks_completed.length;
            if (_this.pro.tasks.length == 0) {
                _this.task = true;
            }
        });
        this.keywords = JSON.parse(localStorage.getItem('keywords'));
    }
    ViewProjectsPage.prototype.ngOnInit = function () {
    };
    ViewProjectsPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        // this.pro.overviews.project_team_members.forEach(element => {
        //   var img = this.pro.overviews.user_profile_path + element.avatar;
        //   element.avatar = img;
        // });
        this.pro.tasks.forEach(function (element) {
    ...
    ViewProjectsPage.prototype.getProgresstyle = function () {
        return {
            background: "linear-gradient(to right," + this.secondryColor + "," + this.primaryColor + ")"
        };
    };
    ViewProjectsPage.prototype.getHeaderStyle = function () {
        return { background: this.primaryColor };
    };
    ViewProjectsPage.prototype.getFontstyle = function () {
        return { color: this.secondryColor };
    };
    ViewProjectsPage.prototype.setDefaultPic = function () {
        this.pro.overviews.project_lead_photo = "assets/imgs/user.jpg";
    };
    ;
    ViewProjectsPage.prototype.setDefaultUserPic = function (img) {
        img.avatar = "assets/imgs/user.jpg";
    };
    ;
    ViewProjectsPage.prototype.openTask = function (task) {
        var data = JSON.stringify({ task: task, project: this.pro });
        this.navCtrl.navigateForward('task-details/' + data);
    };
    ;
    ViewProjectsPage.prototype.add = function () {
    ...
    ViewProjectsPage.prototype.onDaySelect = function (event) {
        //console.log(event);
    ...
    ViewProjectsPage.prototype.onMonthSelect = function (event) {
        //console.log(event)
    };
    ViewProjectsPage.prototype.createTask = function () {
    ...
    ViewProjectsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=view-projects-view-projects-module-es5.js.map