...
let SettingsPage = class SettingsPage {
    constructor(navCntrl, route, util, modalController) {
    ...
    changePassword() {
        let component = _change_password_change_password_page__WEBPACK_IMPORTED_MODULE_5__["ChangePasswordPage"];
        this.openModal(component);
    }
    companySettings() {
        let component = _company_settings_company_settings_page__WEBPACK_IMPORTED_MODULE_6__["CompanySettingsPage"];
        this.openModal(component);
    }
    notificationSettings() {
        let component = _notification_settings_notification_settings_page__WEBPACK_IMPORTED_MODULE_7__["NotificationSettingsPage"];
        this.openModal(component);
    }
    emailSettings() {
        let component = _email_settings_email_settings_page__WEBPACK_IMPORTED_MODULE_8__["EmailSettingsPage"];
        this.openModal(component);
    }
    locationSettings() {
        let component = _location_settings_location_settings_page__WEBPACK_IMPORTED_MODULE_9__["LocationSettingsPage"];
        this.openModal(component);
    }
    salarySettings() {
        let component = _salary_settings_salary_settings_page__WEBPACK_IMPORTED_MODULE_10__["SalarySettingsPage"];
        this.openModal(component);
    }
    invoiceSettings() {
        let component = _invoice_settings_invoice_settings_page__WEBPACK_IMPORTED_MODULE_11__["InvoiceSettingsPage"];
        this.openModal(component);
    }
    leaveType() {
