...
procedure TFrmMSetting.VisibleALLGridDetail(tipe:boolean=False);
begin
...
procedure TFrmMSetting.BtnCloseClick(Sender: TObject);
begin
  Close;
end;
procedure TFrmMSetting.cekAllEditModule(idm:integer);
var
  md : string;
  qk : tzquery;
begin
...
procedure TFrmMSetting.isiALLTableKolom;
var
  idm : integer;
  qk : tzquery;
begin
...
procedure TFrmMSetting.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TFrmMSetting.FormCreate(Sender: TObject);
begin
  isdebug := True;
  txtID.Text         := IDModule;
...
procedure TFrmMSetting.SettingQuery;
var
  idd, idm : integer;
  qd  : tzquery;
  namagrid : string;
...
procedure TFrmMSetting.SettingGridDetail;
var
  idd, idm : integer;
  qd  : tzquery;
  namagrid : string;
...
procedure TFrmMSetting.ReloadClick;
var
  idm : integer;
begin
  idm               := strtoint(txtid.Text);
...
procedure TFrmMSetting.SettingFont;
var
  x, fs : integer;
  fn : string;
begin
...
procedure TFrmMSetting.ValidasiControl;
var
  mn : string;
begin
...
procedure TFrmMSetting.ShowDateTemplate(Tipe:Boolean=True);
begin
...
procedure TFrmMSetting.BtnStartdateKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then ReloadClick;
end;

procedure TFrmMSetting.BtnStartdatePropertiesChange(Sender: TObject);
begin
  if DisableChangeDate then exit;
  startdate := BtnStartdate.Date;
end;
procedure TFrmMSetting.BtnEnddateKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then ReloadClick;
end;

procedure TFrmMSetting.BtnEnddatePropertiesChange(Sender: TObject);
begin
  if DisableChangeDate then exit;
  enddate := BtnEnddate.Date;
end;
procedure TFrmMSetting.MenuItem1Click(Sender: TObject);
begin
  //first date to now
...
procedure TFrmMSetting.OneMonth1Click(Sender: TObject);
begin
  //one month
  if BtnDateTemplate.Visible = False then Exit;
  DisableChangeDate := true;
...
procedure TFrmMSetting.NextMonth1Click(Sender: TObject);
begin
  //next month
  if BtnDateTemplate.Visible = False then Exit;
  DisableChangeDate := true;
...
procedure TFrmMSetting.PrevMonth1Click(Sender: TObject);
begin
  //prev month
  if BtnDateTemplate.Visible = False then Exit;
  DisableChangeDate := true;
...
procedure TFrmMSetting.OneYear1Click(Sender: TObject);
begin
  //one year
  if BtnDateTemplate.Visible = False then Exit;
  DisableChangeDate := true;
...
procedure TFrmMSetting.OneDay1Click(Sender: TObject);
begin
  //oneday
  if BtnDateTemplate.Visible = False then Exit;
  DisableChangeDate := true;
...
procedure TFrmMSetting.oday1Click(Sender: TObject);
begin
  //today
  if BtnDateTemplate.Visible = False then Exit;
  DisableChangeDate := true;
...
procedure TFrmMSetting.actStartdateExecute(Sender: TObject);
begin
  BtnStartdate.SetFocus;
end;
procedure TFrmMSetting.actEnddateExecute(Sender: TObject);
begin
  BtnEnddate.SetFocus;
end;
...
//grid
function TFrmMSetting.getFocusQuery : TZQuery;
begin
...
function TFrmMSetting.getFocusTableName : String;
var
  x : integer;
  idtag : integer;
begin
...
function TFrmMSetting.getFocusGrid : TcxGridDBBandedTableView;
var
  x : integer;
begin
...
function TFrmMSetting.getFocusGridView : TcxGridDBBandedTableView;
var
  x : integer;
begin
  for x := 0 to ComponentCount - 1 do
...
function TFrmMSetting.getActiveModuleName : string;
var
  id1 : string;
begin
...
procedure TFrmMSetting.ApplicationEvents1Exception(Sender: TObject; E: Exception);
begin
  MsgError(e.Message);
  isNowEdit[strtoint(txtid.Text)]    := False;
end;

procedure TFrmMSetting.AutoActiveQuery;
var
  x : integer;
begin
  for x := 0 to ComponentCount - 1 do
...
procedure TFrmMSetting.AutoRefreshQuery;
var
  x : integer;
  qk : TZquery;
begin
...
function TFrmMSetting.getTabByName(nama:string) : TcxTabSheet;
begin
  nama := lowercase(nama);
...
procedure TFrmMSetting.ImportFromExcel1Click(Sender: TObject);
var
  tn : string;
  qc, qk, qi : tzquery;
  idm : integer;
...
function TFrmMSetting.getCxGridByName(nama:string) : TcxGrid;
begin
  nama := lowercase(nama);
...
function TFrmMSetting.getGridByName(nama:string) : TcxGridDBBandedTableView;
begin
  nama := lowercase(nama);
...
function TFrmMSetting.getQueryByName(nama:string) : TZQuery;
begin
  nama := lowercase(nama);
...
procedure TFrmMSetting.actLookupExecute(Sender: TObject);
var
  Q : tzquery;
  s, sql : string;
  idk : integer;
...
procedure TFrmMSetting.actAddExecute(Sender: TObject);
begin
...
procedure TFrmMSetting.actcancelExecute(Sender: TObject);
begin
  getQueryByName(getFocusGridView.Name).Cancel;
end;
procedure TFrmMSetting.actDeleteExecute(Sender: TObject);
begin
...
procedure TFrmMSetting.actEditExecute(Sender: TObject);
begin
...
procedure TFrmMSetting.actRefreshExecute(Sender: TObject);
begin
   //getQueryByName(getFocusGridView.Name).Refresh;
   q_master.Refresh;
end;
procedure TFrmMSetting.actSaveExecute(Sender: TObject);
begin
  if isnowedit[getQueryByName(getFocusGridView.Name).Tag]  then getQueryByName(getFocusGridView.Name).Post;
end;
procedure TFrmMSetting.actTabDetail1Execute(Sender: TObject);
begin
  exit;
...
procedure TFrmMSetting.actTabDetail2Execute(Sender: TObject);
begin
  exit;
  if PageDetail.Visible = true then
  begin
...
procedure TFrmMSetting.actTabMasterExecute(Sender: TObject);
begin
...
//popup menu
procedure TFrmMSetting.ppExportClick(Sender: TObject);
begin
  if Confirm('Export Excel ?') = 'YES' then  ExportGrid('Excel', getCxGridByName(getfocusgridview.Name) );
end;
procedure TFrmMSetting.PopupMenuPopup(Sender: TObject);
var
  mn : string;
begin
...
procedure TFrmMSetting.ppFreezeClick(Sender: TObject);
var
  caption : string;
  x : integer;
begin
...
procedure TFrmMSetting.ppGroupDefaultClick(Sender: TObject);
begin
  GroupDateFormatClick(getFocusGridView, 'default');
end;
procedure TFrmMSetting.ppGroupMonthClick(Sender: TObject);
begin
  GroupDateFormatClick(getFocusGridView, 'month');
end;
procedure TFrmMSetting.ppGroupYearClick(Sender: TObject);
begin
  GroupDateFormatClick(getFocusGridView, 'year');
end;
procedure TFrmMSetting.RelativeToday1Click(Sender: TObject);
begin
  GroupDateFormatClick(getFocusGridView, 'relative');
end;
procedure TFrmMSetting.ppFindClick(Sender: TObject);
begin
...
procedure TFrmMSetting.ppShowALLClick(Sender: TObject);
begin
  //dbg(getQueryByName(getFocusGridView.Name).Name);
...
//isnowedit master
procedure TFrmMSetting.Q_MASTERNewRecord(DataSet: TDataSet);
begin

  NewRecordQ(Dataset.Tag, dataset.Name);
end;
procedure TFrmMSetting.Q_MASTERBeforeEdit(DataSet: TDataSet);
begin
  BeforeEditQ(dataset.Tag, Dataset.Name);
end;
procedure TFrmMSetting.Q_MASTERBeforeDelete(DataSet: TDataSet);
begin
  BeforeDeleteQ(Dataset.Tag, dataset.Name);
end;
procedure TFrmMSetting.Q_MASTERAfterDelete(DataSet: TDataSet);
begin
  AfterDeleteQ(DataSet.Tag, dataset.Name);
end;
procedure TFrmMSetting.Q_MASTERBeforePost(DataSet: TDataSet);
begin
  BeforePostQ(DataSet.Tag, Dataset.Name);
end;
procedure TFrmMSetting.Q_MASTERAfterPost(DataSet: TDataSet);
begin
  AfterPostQ(DataSet.Tag, dataset.Name);
end;
procedure TFrmMSetting.Q_MASTERAfterRefresh(DataSet: TDataSet);
begin
  AutoRefreshQuery;
end;
procedure TFrmMSetting.Q_MASTERAfterCancel(DataSet: TDataSet);
begin
...
//procedure query
procedure TFrmMSetting.AfterCancelQ(idm : integer; nama:string);
begin
  nama := lowercase(nama);
...
procedure TFrmMSetting.AfterDeleteQ(idm : integer; nama:string);
begin
  nama := lowercase(nama);
  nama := replace(nama, 'q_', '');
  isnowedit[idm] := False;
...
procedure TFrmMSetting.AfterPostQ(idm : integer; nama:string);
begin
  nama := lowercase(nama);
  nama := replace(nama, 'q_', '');
  isnowedit[idm] := False;
...
procedure TFrmMSetting.BeforeDeleteQ(idm : integer; nama:string);
begin
  nama := lowercase(nama);
  nama := replace(nama, 'q_', '');
...
procedure TFrmMSetting.BeforeEditQ(idm : integer; nama:string);
var
  md : string;
begin
  nama := lowercase(nama);
...
procedure TFrmMSetting.BeforePostQ(idm : integer; nama:string);
begin
  nama := lowercase(nama);
  nama := replace(nama, 'q_', '');
...
procedure TFrmMSetting.NewRecordQ(idm : integer; nama:string);
var
  md : string;
begin
  nama := lowercase(nama);
...
//master
procedure TFrmMSetting.newRecordMaster;
begin
  AutoRefreshQuery;
end;
procedure TFrmMSetting.beforePostMaster;
begin
  //
end;
procedure TFrmMSetting.afterPostMaster;
begin
  q_master.Refresh;
end;
procedure TFrmMSetting.beforeEditMaster;
begin
  //pwd := q_master.getFieldString('password');
end;
procedure TFrmMSetting.beforeDeleteMaster;
begin
  //DeleteAllDataDetail(txtID.Text, q_master.getFieldString('employee_id'));
end;
procedure TFrmMSetting.afterDeleteMaster;
begin
  //
end;
procedure TFrmMSetting.afterCancelMaster;
begin
  //
end;
//end master
...
//mutation q_detail1
procedure TFrmMSetting.newRecordMutation;
begin
  //
end;
procedure TFrmMSetting.beforePostMutation;
begin
  //
end;
procedure TFrmMSetting.afterPostMutation;
begin
  //
end;
procedure TFrmMSetting.beforeEditMutation;
begin
  //
end;
procedure TFrmMSetting.beforeDeleteMutation;
begin
//
end;
procedure TFrmMSetting.afterDeleteMutation;
begin
  //
end;
procedure TFrmMSetting.afterCancelMutation;
begin
  //
end;
//end mutation
...
//Relatives q_detail2
procedure TFrmMSetting.newRecordRelatives;
begin
  //
end;
procedure TFrmMSetting.beforePostRelatives;
begin
  //
end;
procedure TFrmMSetting.afterPostRelatives;
begin
  q_detail2.Refresh;
end;
procedure TFrmMSetting.beforeEditRelatives;
begin
  //
end;
procedure TFrmMSetting.beforeDeleteRelatives;
begin
  //
end;
procedure TFrmMSetting.afterDeleteRelatives;
begin
  //
end;
procedure TFrmMSetting.afterCancelRelatives;
begin
  //
end;
//end Relatives
...
//Asset q_detail3
procedure TFrmMSetting.newRecordAsset;
begin
  //
end;
procedure TFrmMSetting.beforePostAsset;
begin
  //
end;
procedure TFrmMSetting.afterPostAsset;
begin
  //
end;
procedure TFrmMSetting.beforeEditAsset;
begin
  //
end;
procedure TFrmMSetting.beforeDeleteAsset;
begin
  //
end;
procedure TFrmMSetting.afterDeleteAsset;
begin
  //
end;
procedure TFrmMSetting.afterCancelAsset;
begin
  //
end;
//end Asset
...
//Job q_detail4
procedure TFrmMSetting.newRecordJob;
begin
  //
end;
procedure TFrmMSetting.beforePostJob;
begin
  //
end;
procedure TFrmMSetting.afterPostJob;
begin
  //
end;
procedure TFrmMSetting.beforeEditJob;
begin
  //
end;
procedure TFrmMSetting.beforeDeleteJob;
begin
  //
end;
procedure TFrmMSetting.afterDeleteJob;
begin
  //
end;
procedure TFrmMSetting.afterCancelJob;
begin
  //
end;
//end Job
...
//Training q_detail5
procedure TFrmMSetting.newRecordTraining;
begin
  //
end;
procedure TFrmMSetting.beforePostTraining;
begin
  //
end;
procedure TFrmMSetting.afterPostTraining;
begin
  //
end;
procedure TFrmMSetting.beforeEditTraining;
begin
  //
end;
procedure TFrmMSetting.beforeDeleteTraining;
begin
  //
end;
procedure TFrmMSetting.afterDeleteTraining;
begin
  //
end;
procedure TFrmMSetting.afterCancelTraining;
begin
  //
end;
//end Training
...
//Education q_detail6
procedure TFrmMSetting.newRecordEducation;
begin
//
end;
procedure TFrmMSetting.beforePostEducation;
begin
  //
end;
procedure TFrmMSetting.afterPostEducation;
begin
  //
end;
procedure TFrmMSetting.beforeEditEducation;
begin
  //
end;
procedure TFrmMSetting.beforeDeleteEducation;
begin
  //
end;
procedure TFrmMSetting.afterDeleteEducation;
begin
  //
end;
procedure TFrmMSetting.afterCancelEducation;
begin
  //
end;
//end Education
...
//salary q_detail7
procedure TFrmMSetting.newRecordSalary;
begin
//
end;
procedure TFrmMSetting.beforePostSalary;
begin
  //
end;
procedure TFrmMSetting.afterPostSalary;
begin
  //
end;
procedure TFrmMSetting.beforeEditSalary;
begin
  //
end;
procedure TFrmMSetting.beforeDeleteSalary;
begin
  //
end;
procedure TFrmMSetting.afterDeleteSalary;
begin
  //
end;
procedure TFrmMSetting.afterCancelSalary;
begin
  //
end;
//end salary
