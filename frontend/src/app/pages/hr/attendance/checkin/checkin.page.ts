...
export class CheckinPage implements OnInit {
  ...
  async loadData(mode: number) {
    ...
    if (this.segment === 'checkin') {
      this.datasource_checkin = a; console.log("checkin", this.datasource_checkin);      
    } else if (this.segment === 'checkout') {
      this.datasource_checkout = a; console.log("checkout", this.datasource_checkout);      
    } else if (this.segment === 'checkpoint') {
      this.datasource_checkpoint = a; console.log("checkpoint", this.datasource_checkpoint);      
    } 
